...
Автоматическая установка с помощью wee_extension:
  1. Загрузите последнюю версию Модуля https://github.com/vasiliizakharov/weewx-rp5/releases
      wget -P /tmp https://github.com/vasiliizakharov/weewx-rp5/releases/download/v0.6/weewx-rp5-0.6.tar.gz
  ...
  3. Установите модуль используя утилиту wee_extension
      cd /home/weewx/bin
      ./wee_extension --install=/tmp/weewx-rp5-0.6.tar.gz
...
Ручная установка:
  ...
  3. Распакуйте установочный файл
      tar xvfz weewx-rp5-0.6.tar.gz

  4. Скопируйте распакованные файлы
      cp weewx-rp5/bin/user/*.py /home/weewx/bin/user
